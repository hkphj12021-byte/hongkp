  ...
  const projects = [
    {
      ...
      metrics: ["홈페이지 및 애플리케이션 오픈 완료", "PM/기획 역할 동시진행 기여도 80%", "백오피스 분석 기획설계", "유지보수 관리 구두 협의"]
    },
    {
      ...
      metrics: ["배리어프리 웹사이트 오픈", "웹 접근성 인증마크 획득", "기획 역할 기여도 85%"]
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1594200879785-b6ee4fc48712?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBjYXIlMjB3ZWJzaXRlfGVufDF8fHx8MTc2OTA3MTc2NXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1519114761417-81be330afa42?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb25zdHJ1Y3Rpb24lMjBidWlsZGluZyUyMGFyY2hpdGVjdHVyZXxlbnwxfHx8fDE3NjkwNzE3NjV8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
      tags: ["요구사항 정의", "일정관리", "인력관리", "요구사항 분석", "산출물관리"],
      metrics: ["2차 고도화 기능 협의", "고도화 구두 협의", "사용자 편의성 향상", "PM역할 50%"]
    },
    {
      ...
      metrics: ["핵심 기능 UX개선 및 운영 효율성 향상", "모바일 리뉴얼을 통한 사용자 20~30% 증가", "이벤트 운영을 통한 매출 및 유입 지표개선"]
    },
    {
      ...
      metrics: ["서비스 통합 이후 전체 회원 수 약 30% 이상 증가", "기존 회원 이탈률 약 20% 감소", "플랫폼 운영 안정성 확보"]
    }
  ];
              ...
              <CardHeader>
                <div className="flex items-start justify-between gap-2">
                  <div className="flex-1">
                    {project.client && (
                      <p className="text-sm text-red-600 mb-1">{project.client}</p>
                    )}
                    <h3>{project.title}</h3>
                  </div>
                  <ExternalLink className="w-5 h-5 text-gray-400 group-hover:text-red-600 transition-colors flex-shrink-0" />
                </div>
              </CardHeader>
